                        ...
                        <tr class="cart_table_item">
                            <td class="product-thumbnail">
                                <div class="product-thumbnail-wrapper">
                                    <a href="{{route('accueil.detail', $itemCart->product->id)}}" class="product-thumbnail-remove" title="Remove Product">
                                        <i class="fas fa-times"></i>
                                    </a>
                                    <a href="{{route('accueil.detail', $itemCart->product->id)}}" class="product-thumbnail-image" title="">
                                        <img width="90" height="90" alt="" class="img-fluid" src="{{Storage::url($itemCart->product->image)}}">
                                    </a>
                                </div>
                            </td>
                            <td class="product-name">
                                <a href="{{route('accueil.detail', $itemCart->product->id)}}" class="font-weight-semi-bold text-color-dark text-color-hover-primary text-decoration-none">{{$itemCart->product->name}}</a>
                            </td>
